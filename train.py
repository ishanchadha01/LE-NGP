...
def parse_args():
    ...
    parser.add_argument('--config', help='Path to the training config file.', default='/storage/home/hcoda1/3/ichadha3/p-ychen3538-0/ishan/le-ngp/projects/neuralangelo/configs/custom/ct1a.yaml')
...
def main():
    ...
    print("Loaded checkpoint loader")
...
if __name__ == "__main__":
    import ctypes # fix for pace scripts
    libgcc_s = ctypes.CDLL('libgcc_s.so.1') # fix for pace scripts
    main()
